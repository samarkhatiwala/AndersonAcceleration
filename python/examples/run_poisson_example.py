...
from timestepperfunc_poisson import timestepperfunc_poisson
...
g = lambda x, y, fetchOutput, iter_: timestepperfunc_poisson(x, y, fetchOutput, iter_, A, b, calcNorms=True, mpi=mpiaa)
suff='_test'
ret = andacc(g, xl0, s, AAparams=AAparams, histParams=histParams, doRestart=False, fileSuff=suff, y=None, debug=True, mpi=mpiaa)
